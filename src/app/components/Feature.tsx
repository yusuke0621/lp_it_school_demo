  ...
  const features = [
    {
      ...
      list: rounded01,
      description:
        "Growbase Lab では、IT初心者のために「基礎からステップアップできるカリキュラム」を用意しています。\n知識ゼロの状態からでも、無理なくスキルを身につけていける仕組みがあります。",
      modalDescription:
    ...
    {
      title: ["机上の学習では終わらせない", "働くに直結するカリキュラム"],
      image: features_2,
      list: rounded02,
      description:
        "Growbase Lab のカリキュラムは、ただ学ぶだけで終わりません。\n現役エンジニア/デザイナーが作ったカリキュラムなので実際の現場で使われているツールや手法を取り入れ、仕事で活かせる「リアルなスキル」を段階的に学べます。",
      modalDescription:
        "Growbase Lab のカリキュラムは、ただ学ぶだけで終わりません。\n現役エンジニア/デザイナーが作ったカリキュラムなので実際の現場で使われているツールや手法を取り入れ、仕事で活かせる「リアルなスキル」を段階的に学べます。\n\n実際によく使われるトレンドのツールやプログラミング言語やUI設計、チーム開発、レビュー文化など現場の考え方も習得できます。\n\n「知ってる」だけではなく、「できる」状態に。Growbase Lab では、未経験からでも「現場で活躍できる自分」を目指せます。",
    },
    {
      title: ["学んだその先へ", "働くまでを、伴走します"],
      image: features_3,
      list: rounded03,
      description:
        "Growbase Lab では、学び始める前に転職のプロによるキャリア面談からスタートします。\nキャリア面談を経て、それぞれの「どうすれば仕事にできるか」までを考えたカリキュラム目標を決めてサポートしていきます。",
      modalDescription:

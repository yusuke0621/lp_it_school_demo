...
スタカレは「なにが分からないかも分からない」という方のためのカリキュラム設計になっているため、IT・デザインの知識ゼロからでも安心して学べます。`,
  },
  {
    question: 'どれくらいの期間で転職できますか？',
    answer: `人によって進度は異なりますが、平均して6〜12ヶ月での転職成功を目標としています。
    
        スタカレでは「最短での就職」をゴールにせず、“自分に合ったペースで学び、納得して働ける転職”を大切にしています。
  ...
  },
  {
    ...
    answer: `受講料はプランやサポート内容によって異なりますが、基本的に月額制 or 分割払いにも対応しています。
      ...
      ※スタカレでは転職成功後に企業からの紹介料で収益化するモデルのため、学習者の自己負担は極力少なく抑えています。
...
スタカレでは、「無理なく続けられる」ことを大前提にカリキュラム設計をしています。
...
「フルタイムで働きながら」「家事や育児と両立しながら」という方も多く、メンターチャットサポートが継続をサポートします。`,
  },
  {
    ...
    answer: `ご安心ください。スタカレでは、最初に「キャリア相談」や「適性セッション」を行い、あなたの興味・価値観・得意不得意に応じて、どちらが合っているかを一緒に見つけていきます。
    また、実際に両方に触れてみる体験型の講座もあるので、学びながら選ぶこともできます。`,
  },
  {
    question: '他のスクールと何が違うんですか？',
    answer: `スタカレの特徴は、「未経験者が“ちゃんと続けられて、ちゃんと仕事にできる”」仕組みがあることです。
    ・自分のペースで進められる段階的カリキュラム
    ・モチベーションを保つメンター・勉強会・コミュニティ
    ・「なりたい姿」を一緒に探すキャリア相談と企業紹介 ただ学ぶだけでなく、“なりたい”を“なれる”に変えるサポートが充実しているのが、スタカレならではです。`,
  },
  {
    question: 'オンラインだけですか？対面はありますか？',
    answer: `基本はオンラインですが、「スタカレカフェ（勉強会・交流会）」として対面イベントも実施しています。
    
      リアルで仲間に会える機会や、講師に直接質問できる機会もあるので、オンラインだけだと不安…という方も安心して参加できます。`,
  },
  // 他の質問も同様に
];
